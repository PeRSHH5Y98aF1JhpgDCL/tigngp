class Upgrade {
  ...
  get cost() {
    return D(10).pow(D.log10(this.baseCost.times(D.pow(this.costScale,this.level)).times(D.pow(this.CSI, D.sumArithmeticSeries(this.level, D(1), D(1), D(0))))).mul(this.HyperExpoCSI.pow(this.level)))
  }
